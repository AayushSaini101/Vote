...
// Method to check whether TSC member participate in voting in the more than 3 Months.
...
// Check whether the voteTracking.json file is present in the directory or not 
...
const voteDetailsTCSMembers = fs.readFileSync(filePath, 'utf8');
const voteDetails = JSON.parse(voteDetailsTCSMembers);
const updatedVotes = []
